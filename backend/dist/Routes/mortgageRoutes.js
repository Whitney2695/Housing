...
router.get('/', authMiddleware_1.default.authenticate, mortgageController_1.getAllMortgagesController); // Added route for getting all mortgages
router.get('/:id', authMiddleware_1.default.authenticate, mortgageController_1.getMortgageByIdController);
